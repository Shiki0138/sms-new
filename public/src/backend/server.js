...
// In-memory database (実際の環境ではPostgreSQLなどを使用)
const db = {
  users: [
    {
      id: 1,
      email: 'admin@salon.com',
      password: '$2a$10$kFVBZMghl0Y4dGz1ktSjXOmGawrEj3SJZQqcXKxOvvGzFBKu1Qjmq', // password: admin123
      name: '管理者',
      role: 'admin'
    }
  ],
...
app.listen(PORT, () => {
  console.log(`SMS Backend API running at http://localhost:${PORT}`);
